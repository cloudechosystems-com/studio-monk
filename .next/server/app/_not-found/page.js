    ...
    (e.modules = {
      ...
      8415: (e, r, t) => {
        ...
        let a = [
            ...
            {
              layout: [
                () => Promise.resolve().then(t.bind(t, 9772)),
      ...
      9772: (e, r, t) => {
        "use strict";
        t.r(r), t.d(r, { default: () => p, metadata: () => u });
        var o = t(2740),
          n = t(2202),
          s = t.n(n),
          i = t(4988),
          ...
          l.E.configure({
            Auth: {
              Cognito: {
                ...
                userPoolClientId: a.userPoolWebClientId,
              },
            },
          });
        let u = {
        ...
        function p({ children: e }) {
          return (0, o.jsx)("html", {
            ...
            children: (0, o.jsx)("body", {
              className: `${s().variable} ${d().variable} antialiased`,
              children: e,
            }),
          });
        }
